  ...
  return (
    <div
      className={`sm-scope z-40 pointer-events-none ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden' : 'w-full h-full'}`}>
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-end justify-end p-[2em] bg-transparent pointer-events-none z-20"
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer mt-2 text-[#e9e9ef] font-black uppercase leading-none overflow-visible pointer-events-auto"
            ...
            <span
              ref={textWrapRef}
              className="sm-toggle-textWrap relative inline-block h-[1em] text-md font-bold uppercase tracking-[0.2em]  overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)]"
              aria-hidden="true">
              <span
                ref={textInnerRef}
