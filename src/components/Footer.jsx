...
const FooterCleanClassic = () => {
  return (
    <footer className="bg-red-900 border-t-4 border-black pt-16 pb-8 font-sans">
      <div className="container  mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
          {/* Brand Column */}
          <div className="md:w-1/3 space-y-4">
            <h2 className="text-3xl grotesq1 text-white font-black italic uppercase tracking-tighter">
              The End?
            </h2>
            <p className="text-white grotesq1 font-bold max-w-xs">
            ...
            <div className="relative max-w-xs group">
              ...
              />
              <button className="absolute right-2 top-2 bottom-2 bg-red-400 border-2 border-black px-3 hover:bg-red-300 transition-colors">
          ...
          <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-8">
            {footerLinks.map((section, i) => (
              <div key={i}>
                <h3 className="font-black grotesq1 text-white uppercase tracking-widest mb-6 text-sm border-b-2 border-neutral-200 pb-2 inline-block">
                  {section.title}
                </h3>
                <ul className="space-y-3">
                  {section.items.map((item, j) => (
                    <li key={j}>
                      <motion.a
                        href="#"
                        className="inline-block grotesq1 font-bold text-white relative"
                        whileHover={{ x: 5 }}
                      >
